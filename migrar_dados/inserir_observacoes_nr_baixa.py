...
def insere_observacoes():
    ...
    lancamentos = utils.fetch_results("""SELECT id,guia_iss_govdigital_id,id_gerado,nro_baixa FROM lancamento where obs_enviada is null and id_gerado is not null and situacao = 'SUCESSO'""")
